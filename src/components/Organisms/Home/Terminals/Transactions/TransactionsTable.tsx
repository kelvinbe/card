...
function TransactionsTable<TData, TValue>({columns, data}:DataTableProps<TData, TValue>) {
  ...
  return (
    <Box>
        ...
        {selectedOperation &&  <Box m={5} display={'flex'} justifyContent={'space-between'} alignItems={'center'}>
          <Box display={'flex'}>
          <FilterByComponent variant='location' borderRadius='full'  buttonWidth='150' chevronColor='#000' textColor='#fff' data={locationData} popOverWidth='100' /> 
         {selectedOperation === 'Status' && <FilterByComponent variant='status' borderRadius='full'  buttonWidth='150' chevronColor='#000' textColor='#fff' data={StatusData} popOverWidth='100' /> }
         </Box>
